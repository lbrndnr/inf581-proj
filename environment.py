...
class environment:
    ...
    """
    def __init__(self, copied_env_state=None, maze_size=20, initial_snake_size=5, mice_points=[1,2,3], fixed_obstacles=[(3,4),(3,5),(3,6)]):
        self.maze_size = maze_size
        if copied_env_state != None:
            # if there is a environment to be copied from.
            obstacles, mice, head, curr_direction, score = copied_env_state
            self.score = 0
